...
def main():
    ...
    if len(sys. argv)!= 2:
        print("Usage: python script.py <C:/Users/sivan/OneDrive/Documents/GitHub/COMP593-Lab3/sales_data.py>")
        sys. exit(1)
    ...
    for order_id, order_data in sales_data. groupby('ORDER ID'):
        ...
        # Export to the next Excel sheet
        ...
        with pd.ExcelWriter(excel_file_path, engine='xlsxwriter') as writer:
            ...
            # Setting variables to workbook and worksheet objects
            ...
            # Record the over-all total
            worksheet. write(len(order_data) + 1, 4, 'Grand Tota')
